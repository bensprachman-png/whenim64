...
export async function PUT(req: NextRequest) {
  ...
  const {
    ...
    ssPaymentsPerYear, ssMonthlyFraBenefit, spouseSsStartYear, spouseSsPaymentsPerYear, spouseSsMonthlyFraBenefit,
  ...
  const values = {
    ...
    ssMonthlyFraBenefit: ssMonthlyFraBenefit ?? 0,
    spouseSsStartYear: spouseSsStartYear ?? null,
    spouseSsPaymentsPerYear: spouseSsPaymentsPerYear ?? 0,
    spouseSsMonthlyFraBenefit: spouseSsMonthlyFraBenefit ?? 0,
